...
/* Additional SUSFS constants */
#define SUSFS_MAGIC 0x53555346
#define CMD_SUSFS_ADD_SUS_PATH_LOOP 0x55551
#define CMD_SUSFS_SET_ANDROID_DATA_ROOT_PATH 0x55561
#define CMD_SUSFS_SET_SDCARD_ROOT_PATH 0x55562
#define CMD_SUSFS_HIDE_SUS_MNTS_FOR_ALL_PROCS 0x55563
#define CMD_SUSFS_ADD_SUS_MAP 0x55564
#define CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING 0x55565
